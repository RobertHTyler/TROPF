...
[Dns,Rns,pns, calWns,calDns,calEKns,calEPns,tiltauns,knFsF] = tropf(N,tilOm, tilom,s,Gns,Kns,dns,ens, tilalpd,tilalpr,tilnusqns);
% build 3D arrays of variables (lon,lat,time):
[tilD_fieldMov,  ud_fieldMov,vd_fieldMov]  = buildMovie(Dns, lon,lat,tiltVec, s,tilom,phase0);
[tilR_fieldMov,              junk1,junk2]  = buildMovie(-1i*Rns, lon,lat,tiltVec, s,tilom,phase0);
ur_fieldMov = junk2; vr_fieldMov = -junk1; clear junk1 junk2
[tilG_fieldMov]                            = buildMovie(-1i*Gns, lon,lat,tiltVec, s,tilom,phase0);
[tilp_fieldMov]                            = buildMovie(-1i*pns, lon,lat,tiltVec, s,tilom,phase0);
[tilPTp_fieldMov]                          = buildMovie(-1i*(-1i*tilom)*pns, lon,lat,tiltVec, s,tilom,phase0);
% work field:
...
PnFsF_amp20=PnFsF_amp;Dns20=Dns;Rns20=Rns;pns20=pns; calWns20=calWns;calDns20=calDns;calEKns20=calEKns;calEPns20=calEPns;tiltauns20=tiltauns;knFsF20=knFsF;
...
tildissip_fieldMov = tilalpd*(ud_fieldMov.*ud_fieldMov + vd_fieldMov.*vd_fieldMov) +  tilalpr*(ur_fieldMov.*ur_fieldMov + vr_fieldMov.*vr_fieldMov) ;
% Rename some solution variables:
PnFsF_amp22W=PnFsF_amp;Dns22W=Dns;Rns22W=Rns;pns22W=pns; calWns22W=calWns;calDns22W=calDns;calEKns22W=calEKns;calEPns22W=calEPns;tiltauns22W=tiltauns;knFsF22W=knFsF;
...
tildissip_fieldMov = tilalpd*(ud_fieldMov.*ud_fieldMov + vd_fieldMov.*vd_fieldMov) +  tilalpr*(ur_fieldMov.*ur_fieldMov + vr_fieldMov.*vr_fieldMov) ;
% Rename some solution variables:
PnFsF_amp22E=PnFsF_amp;Dns22E=Dns;Rns22E=Rns;pns22E=pns; calWns22E=calWns;calDns22E=calDns;calEKns22E=calEKns;calEPns22E=calEPns;tiltauns22E=tiltauns;knFsF22E=knFsF;
...
tildissip_fieldMov = tilalpd*(ud_fieldMov.*ud_fieldMov + vd_fieldMov.*vd_fieldMov) +  tilalpr*(ur_fieldMov.*ur_fieldMov + vr_fieldMov.*vr_fieldMov) ;
% Rename some solution variables:
PnFsF_amp21W=PnFsF_amp;Dns21W=Dns;Rns21W=Rns;pns21W=pns; calWns21W=calWns;calDns21W=calDns;calEKns21W=calEKns;calEPns21W=calEPns;tiltauns21W=tiltauns;knFsF21W=knFsF;
...
tildissip_fieldMov = tilalpd*(ud_fieldMov.*ud_fieldMov + vd_fieldMov.*vd_fieldMov) +  tilalpr*(ur_fieldMov.*ur_fieldMov + vr_fieldMov.*vr_fieldMov) ;
% Rename some solution variables:
PnFsF_amp21E=PnFsF_amp;Dns21E=Dns;Rns21E=Rns;pns21E=pns; calWns21E=calWns;calDns21E=calDns;calEKns21E=calEKns;calEPns21E=calEPns;tiltauns21E=tiltauns;knFsF21E=knFsF;
